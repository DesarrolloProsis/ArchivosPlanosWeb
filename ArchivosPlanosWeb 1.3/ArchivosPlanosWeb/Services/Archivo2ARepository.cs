...
namespace ArchivosPlanosWeb.Services
{
    public class Archivo2ARepository
    {
        ...
        /// <returns></returns>
        public string Preliquidaciones_de_cajero_receptor_para_transito_vehicular(string Str_Turno_block, DateTime FechaInicio, string IdPlazaCobro, string CabeceraTag, string Tramo)
        {
            ...
            try
            {
                ...
                string StrGrupo;
                string StrConcepto;
                string StrTipoConcepto_A;
                string StrTipoConcepto_B;
                string StrTipoConcepto_C;
                string StrTipoConceptoGenero_A;
                string StrTipoConceptoGenero_B;
                ...
                double Db_acom_65 = 0;
                double Db_acom_67 = 0;
                double Db_acom_folios = 0;
                double Db_acom_folios2 = 0;
                double Db_acom_folios3 = 0;
                double Db_acom_eventos = 0;
                    ...
                    for (int i = 0; i < MtGlb.Ds3.Tables["TYPE_VOIE"].Rows.Count; i++)
                    {
                        ...
                        if (MtGlb.QueryDataSet2(StrQuerys, "REDDITION"))
                        {
                            ...
                            if (Convert.ToInt32(MtGlb.oDataRow2["Expr23"]) > 0)
                                ...
                                VAR_73 = Math.Abs(Convert.ToSByte(MtGlb.oDataRow2["Expr23"]));
