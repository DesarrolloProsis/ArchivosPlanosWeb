                        ...
                        if (!DBNull.Value.Equals(MtGlb.oDataRow["CLASE_DETECTADA"]))
                        {
                            ...
                            if (!DBNull.Value.Equals(MtGlb.oDataRow["CLASE_DETECTADA"]))
                            {
                                ...
                                else if (MtGlb.oDataRow["CLASE_DETECTADA"].ToString() == "TLnnA")
                                {
                                    ...
                                    Str_det = "T01L" + MtGlb.IIf(MtGlb.oDataRow["ID_OBS_TT"].ToString().Length == 1, "0" + MtGlb.oDataRow["ID_OBS_TT"], MtGlb.oDataRow["ID_OBS_TT"].ToString());
                                }
                                ...
                                else if (MtGlb.oDataRow["CLASE_DETECTADA"].ToString() == "TPnnC")
                                {
                                    ...
                                    Str_det = "T09P" + MtGlb.IIf(MtGlb.oDataRow["ID_OBS_TT"].ToString().Length == 1, "0" + MtGlb.oDataRow["ID_OBS_TT"], MtGlb.oDataRow["ID_OBS_TT"].ToString());
                                }
                                else
                            ...
                            if (MtGlb.QueryDataSet4(StrQuerys, "TABLE_TARIF"))
                            {
                                if (Convert.ToInt32(MtGlb.oDataRow["ACD_CLASS"]) > 0 && Convert.ToInt32(MtGlb.oDataRow["ACD_CLASS"]) <= 9)
                                {
                                    ...
                                    Db_det = MtGlb.oDataRow["MONTO_DETECTADO"].ToString();
                                    Db_det_ejes = Convert.ToString(0);
                                }
                                ...
                                else if (Convert.ToInt32(MtGlb.oDataRow["ACD_CLASS"]) >= 10 && Convert.ToInt32(MtGlb.oDataRow["ACD_CLASS"]) <= 11)
                                {
                                    ...
                                    Db_det_ejes = (Convert.ToInt32(MtGlb.oDataRow["MONTO_DETECTADO"]) - Convert.ToInt32(MtGlb.oDataRow4["Prix_Cl01"])).ToString();
                                }
                                else if (Convert.ToInt32(MtGlb.oDataRow["ACD_CLASS"]) == 16)
                                {
                                    ...
                                    Db_det_ejes = (Convert.ToInt32(MtGlb.oDataRow["MONTO_DETECTADO"]) - Convert.ToInt32(MtGlb.oDataRow4["Prix_Cl09"])).ToString();
                                }
                            ...
                            if (!DBNull.Value.Equals(MtGlb.oDataRow["CLASE_MARCADA"]))
                            {
                                ...
                                else if (MtGlb.oDataRow["CLASE_MARCADA"].ToString() == "TLnnA")
                                {
                                    ...
                                    Str_marc = "T01L" + MtGlb.IIf(MtGlb.oDataRow["CODE_GRILLE_TARIF"].ToString().Length == 1, "0" + MtGlb.oDataRow["CODE_GRILLE_TARIF"], MtGlb.oDataRow["CODE_GRILLE_TARIF"].ToString());
                                }
                                ...
                                else if (MtGlb.oDataRow["CLASE_MARCADA"].ToString() == "TPnnC")
                                {
                                    ...
                                    Str_marc = "T09P" + MtGlb.IIf(MtGlb.oDataRow["CODE_GRILLE_TARIF"].ToString().Length == 1, "0" + MtGlb.oDataRow["CODE_GRILLE_TARIF"], MtGlb.oDataRow["CODE_GRILLE_TARIF"].ToString());
                                }
                                else
                                    Str_detalle = Str_detalle + "No detectada" + ",0,";
                            }
                            ...
                            {
                                if (MtGlb.oDataRow["Voie"].ToString().Trim() == "A14" || MtGlb.oDataRow["Voie"].ToString().Trim() == "A01" || MtGlb.oDataRow["Voie"].ToString().Trim() == "B14" || MtGlb.oDataRow["Voie"].ToString().Trim() == "B10")
                                    Bl_sin_pre = true;
                            }
                            ...
                            if (IdPlazaCobro.Substring(1, 2) == "08")
                            {
                                if (MtGlb.oDataRow["Voie"].ToString().Trim() == "A08" || MtGlb.oDataRow["Voie"].ToString().Trim() == "A09" || MtGlb.oDataRow["Voie"].ToString().Trim() == "B01")
                                    Bl_det_a_pos = true;
                            }
                            ...
                            {
                                if (MtGlb.oDataRow["Voie"].ToString().Trim() == "A01" || MtGlb.oDataRow["Voie"].ToString().Trim() == "B02")
                                    Bl_sin_pre = true;
                            }
                            //paso morelos
                            ...
                            {
                                if (MtGlb.oDataRow["Voie"].ToString().Trim() == "A02" || MtGlb.oDataRow["Voie"].ToString().Trim() == "B07")
                                    Bl_det_a_pos = true;

                                if (MtGlb.oDataRow["Voie"].ToString().Trim() == "A09" || MtGlb.oDataRow["Voie"].ToString().Trim() == "B10")
                                    Bl_sin_pre = true;
                            }
                            ...
                            {
                                if (MtGlb.oDataRow["Voie"].ToString().Trim() == "B01" || MtGlb.oDataRow["Voie"].ToString().Trim() == "B03" || MtGlb.oDataRow["Voie"].ToString().Trim() == "A02" || MtGlb.oDataRow["Voie"].ToString().Trim() == "A04")
                                    Bl_sin_pre = true;
                            }
                            ...
                            if (IdPlazaCobro.Substring(1, 2) == "08")
                            {
                                if (MtGlb.oDataRow["Voie"].ToString().Trim() == "B01" || MtGlb.oDataRow["Voie"].ToString().Trim() == "B04" || MtGlb.oDataRow["Voie"].ToString().Trim() == "A21")
                                    Bl_sin_pre = true;
                            }
                            ...
                            {
                                if (MtGlb.oDataRow["Voie"].ToString().Trim() == "A01" || MtGlb.oDataRow["Voie"].ToString().Trim() == "A02")
                                    Bl_sin_pre = true;
                            }
                            ...
                            {
                                if (MtGlb.oDataRow["Voie"].ToString().Trim() == "A01" || MtGlb.oDataRow["Voie"].ToString().Trim() == "A02" || MtGlb.oDataRow["Voie"].ToString().Trim() == "B03" || MtGlb.oDataRow["Voie"].ToString().Trim() == "B04")
                                    Bl_sin_pre = true;
                            }
                            ...
                            {
                                if (MtGlb.oDataRow["Voie"].ToString().Trim() == "A09" || MtGlb.oDataRow["Voie"].ToString().Trim() == "B01")
                                    Bl_sin_pre = true;
                            }
                            ...
                            {
                                if (MtGlb.oDataRow["Voie"].ToString().Trim() == "A08" || MtGlb.oDataRow["Voie"].ToString().Trim() == "B01")
                                    Bl_sin_pre = true;
                            }
                            ...
                            else
                            {
                                ...
                                {
                                    //PRECLASIFICADOS
                                    if (!DBNull.Value.Equals(MtGlb.oDataRow["CLASE_PRE"]))
                                    {
                                        StrClaseExcedente = string.Empty;

                                        if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "T01A")
                                        {
                                            Str_detalle = Str_detalle + "T01" + ",";
                                            Str_pre = "T01";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "T01M")
                                        {
                                            Str_detalle = Str_detalle + "T01" + ",";
                                            Str_pre = "T01";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "T01T")
                                        {
                                            Str_detalle = Str_detalle + "T09P01" + ",";
                                            Str_pre = "T09P01";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "T02B")
                                        {
                                            Str_detalle = Str_detalle + "T02" + ",";
                                            Str_pre = "T02";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "T03B")
                                        {
                                            Str_detalle = Str_detalle + "T03" + ",";
                                            Str_pre = "T03";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "T04B")
                                        {
                                            Str_detalle = Str_detalle + "T04" + ",";
                                            Str_pre = "T04";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "T02C")
                                        {
                                            Str_detalle = Str_detalle + "T02" + ",";
                                            Str_pre = "T02";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "T03C")
                                        {
                                            Str_detalle = Str_detalle + "T03" + ",";
                                            Str_pre = "T03";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "T04C")
                                        {
                                            Str_detalle = Str_detalle + "T04" + ",";
                                            Str_pre = "T04";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "T05C")
                                        {
                                            Str_detalle = Str_detalle + "T05" + ",";
                                            Str_pre = "T05";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "T06C")
                                        {
                                            Str_detalle = Str_detalle + "T06" + ",";
                                            Str_pre = "T06";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "T07C")
                                        {
                                            Str_detalle = Str_detalle + "T07" + ",";
                                            Str_pre = "T07";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "T08C")
                                        {
                                            Str_detalle = Str_detalle + "T08" + ",";
                                            Str_pre = "T08";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "T09C")
                                        {
                                            Str_detalle = Str_detalle + "T09" + ",";
                                            Str_pre = "T09";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "TL01A")
                                        {
                                            Str_detalle = Str_detalle + "T01L01" + ",";
                                            Str_pre = "T01L01";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "TL02A")
                                        {
                                            Str_detalle = Str_detalle + "T01L02" + ",";
                                            Str_pre = "T01L02";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "TLnnA")
                                        {
                                            if (MtGlb.IsNumeric(MtGlb.oDataRow["PRE_EJES_EX"].ToString()))
                                            {
                                                if (Convert.ToInt32(MtGlb.oDataRow["PRE_EJES_EX"]) != 0)
                                                {
                                                    Str_detalle = Str_detalle + "T01L" + MtGlb.IIf(MtGlb.oDataRow["PRE_EJES_EX"].ToString().Length == 1, "0" + MtGlb.oDataRow["PRE_EJES_EX"], MtGlb.oDataRow["PRE_EJES_EX"].ToString()) + ",";
                                                    Str_pre = "T01L" + MtGlb.IIf(MtGlb.oDataRow["PRE_EJES_EX"].ToString().Length == 1, "0" + MtGlb.oDataRow["PRE_EJES_EX"], MtGlb.oDataRow["PRE_EJES_EX"].ToString());
                                                }
                                                else
                                                {
                                        ...
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "T01P")
                                        {
                                            Str_detalle = Str_detalle + "T01P" + ",";
                                            Str_pre = "T01P";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "TP01C")
                                        {
                                            Str_detalle = Str_detalle + "T09P01" + ",";
                                            Str_pre = "T09P01";
                                        }
                                        else if (MtGlb.oDataRow["CLASE_PRE"].ToString() == "TPnnC")
                                        {
                                            if (MtGlb.IsNumeric(MtGlb.oDataRow["PRE_EJES_EX"].ToString()))
                                            {
                                                Str_detalle = Str_detalle + "T09P" + MtGlb.IIf(MtGlb.oDataRow["PRE_EJES_EX"].ToString().Length == 1, "0" + MtGlb.oDataRow["PRE_EJES_EX"], MtGlb.oDataRow["PRE_EJES_EX"].ToString()) + ",";
                                                Str_pre = "T09P" + MtGlb.IIf(MtGlb.oDataRow["PRE_EJES_EX"].ToString().Length == 1, "0" + MtGlb.oDataRow["PRE_EJES_EX"], MtGlb.oDataRow["PRE_EJES_EX"].ToString());
                                            }
                                            else
                                            {
                                                Str_detalle = Str_detalle + "T01L08" + ",";
                                    ...
                                    if (MtGlb.QueryDataSet4(StrQuerys, "TABLE_TARIF"))
                                    {
                                        if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 1)
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl01"] + ",";
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 2)
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl02"] + ",";
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 3)
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl03"] + ",";
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 4)
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl04"] + ",";
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 5)
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl05"] + ",";
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 6)
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl06"] + ",";
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 7)
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl07"] + ",";
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 8)
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl08"] + ",";
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 9)
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl09"] + ",";
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 12)
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl12"] + ",";
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 13)
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl13"] + ",";
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 14)
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl14"] + ",";
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 15)
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl15"] + ",";
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 10)
                                        {
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl01"] + ",";
                                            Str_detalle = Str_detalle + 1 * Convert.ToInt32(MtGlb.oDataRow4["Prix_Cl17"]);
                                        }
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 11)
                                        {
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl01"] + ",";
                                            Str_detalle = Str_detalle + 2 * Convert.ToInt32(MtGlb.oDataRow4["Prix_Cl17"]);
                                        }
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 16)
                                        {
                                            if (MtGlb.IsNumeric(MtGlb.oDataRow["PRE_EJES_EX"].ToString()))
                                            {
                                                Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl09"] + ",";
                                                Str_detalle = Str_detalle + Convert.ToInt32(MtGlb.oDataRow["PRE_EJES_EX"]) * Convert.ToInt32(MtGlb.oDataRow4["Prix_Cl16"]);
                                            }
                                            else
                                            {
                                                Str_detalle = Str_detalle + "0,";
                                        ...
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 17)
                                        {
                                            if (MtGlb.IsNumeric(MtGlb.oDataRow["PRE_EJES_EX"].ToString()))
                                            {
                                                Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl01"] + ",";
                                                Str_detalle = Str_detalle + (Convert.ToInt32(MtGlb.oDataRow["PRE_EJES_EX"]) * Convert.ToInt32(MtGlb.oDataRow4["Prix_Cl17"]));
                                            }
                                            else
                                            {
                                                Str_detalle = Str_detalle + "0,";
                                        ...
                                        else if (Convert.ToInt32(MtGlb.oDataRow["ID_CLASE_PRE"]) == 18)
                                        {
                                            Str_detalle = Str_detalle + MtGlb.oDataRow4["Prix_Cl09"] + ",";
