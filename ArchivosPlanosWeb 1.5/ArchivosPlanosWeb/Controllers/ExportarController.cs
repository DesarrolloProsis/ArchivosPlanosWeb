...
namespace ArchivosPlanosWeb.Controllers
{
    public class ExportarController : Controller
    {
        ...
        public ActionResult Index(ControlesExportar model)
        {
            ...
            ArchivoLLRepository archivoLL = new ArchivoLLRepository();
            ...
            else
            {
                ...
                archivoLL.Registro_usuarios_telepeaje(Turno.Text, FechaInicio, Convert.ToString("1" + Plaza.Value), Convert.ToString(Delegacion.Value), "01");
                ...
                Response.Write("<script>alert('Archivo 1A: " + archivo1A.Message + "\\nArchivo 2A: " + archivo2A.Message + "\\nArchivo 9A: " + archivo9A.Message +
                                "\\nArchivo LL: " + archivoLL.Message + "\\nArchivo PA: " + archivoPA.Message + "');</script>");
