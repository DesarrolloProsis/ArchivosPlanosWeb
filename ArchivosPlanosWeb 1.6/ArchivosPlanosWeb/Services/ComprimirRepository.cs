...
namespace ArchivosPlanosWeb.Services
{
    public class ComprimirRepository
    {
        ...
        public void ComprimirArchivos(DateTime FechaInicio, string Str_Turno_block, string IdPlazaCobro, string Arch1, string Arch2, string Arch3, string Arch4, string Arch5)
        {
            try
            {
                string PathF;
                ...
                var ArchivoRuta = Ruta + Año + "\\" + Mes + "\\" + FechaInicio.ToString("dd") + "\\";
                ...
                using (ZipFile zip = new ZipFile())
                {
                    ...
                    if (!System.IO.Directory.Exists(ArchivoRuta))
                    ...
                    using (ZipFile Zip2 = new ZipFile())
                    {
                        ...
                        //"000106202017.Z5A"
                        //"000106202017.Z5A"
                        //{ZipFile::C:\ARCHIVOSPLANOS2\2017\junio\20\000106202017.Z5A}
