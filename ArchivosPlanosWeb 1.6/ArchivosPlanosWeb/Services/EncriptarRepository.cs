...
namespace ArchivosPlanosWeb.Services
{
    public class EncriptarRepository
    {
        ...
        public void EncriptarArchivos(DateTime FechaInicio, string Str_Turno_block, string IdPlazaCobro, string Arch1, string Arch2, string Arch3, string Arch4, string Arch5)
        {
            try
            {
                ...
                string Dir_archivo_sinEncriptar = Ruta + Año + "\\" + Mes + "\\" + FechaInicio.ToString("dd") + "\\" + "SinEncriptar\\";
